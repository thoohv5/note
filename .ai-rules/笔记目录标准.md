...
Algorithm/知识点/
Infrastructure/Database/MySQL/知识点/
Infrastructure/Database/PostgreSQL/知识点/
...
Infrastructure/Database/PostgreSQL/错误/  ← 错误属于哪个主题？
Infrastructure/Database/PostgreSQL/错误收集/
Infrastructure/Database/PostgreSQL/Postgres/问题点/
...
| `PostgresSQL` | `PostgreSQL` | `Infrastructure/Database/PostgreSQL/` |
